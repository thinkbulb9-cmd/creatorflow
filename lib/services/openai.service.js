  ...
  const res = await fetch('https://api.openai.com/v1/chat/completions', {
    ...
    body: JSON.stringify({ 
      ...
      messages: [
        { 
          role: 'system', 
          content: `You are a YouTube content strategist with deep platform expertise. Evaluate video concepts realistically and critically based on actual platform performance data.

Scoring Philosophy:
- Most concepts score between 4-7 (this is the realistic range)
- Score 1-3: Fundamental issues, unlikely to perform
- Score 4-5: Has potential but needs significant improvement
- Score 6-7: Solid concept with clear audience fit
- Score 8-9: Exceptional concept with high viral potential
- Score 10: Rare, breakthrough concept (use sparingly)

Return JSON with:
{
  "score": number 1-10 (be realistic and critical),
  ...
  "suggested_topics": ["3-5 alternative video concept ideas that would score higher", "only provide if score < 7"],
...
Be harsh but constructive. Most ideas need work. Your job is honest assessment, not encouragement.` 
        },
        { role: 'user', content: `Evaluate this YouTube video concept with brutal honesty: "${concept}"` }
      ], 
